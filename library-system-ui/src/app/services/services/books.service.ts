...
import { approveReturnBorrow } from '../fn/books/approve-return-borrow';
import { ApproveReturnBorrow$Params } from '../fn/books/approve-return-borrow';
...
export class BooksService extends BaseService {
  ...
  /** Path part for operation `approveReturnBorrow()` */
  static readonly ApproveReturnBorrowPath = '/books/borrow/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approveReturnBorrow()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnBorrow$Response(params: ApproveReturnBorrow$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approveReturnBorrow(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approveReturnBorrow$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnBorrow(params: ApproveReturnBorrow$Params, context?: HttpContext): Observable<number> {
    return this.approveReturnBorrow$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
